#!/bin/bash
# Lexsis AI Skill Pack Installer — Lexsis AI — Supplements Vertical
...
echo "║  Lexsis AI — Supplements Vertical              ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""
...
if [ -d ".claude" ] || [ -f "CLAUDE.md" ]; then
  ...
  echo "  → Installed 1 skills + 0 commands"
  INSTALLED=true
fi
