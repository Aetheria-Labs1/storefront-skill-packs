# Supplements — Google Ads Landing Pages

Build high-converting supplement/wellness landing pages optimized for Google Ads intent traffic.
...
### `/optimize-google-landing`
Optimize an existing page for Google Ads intent-matching and quality score
