# Luxury Brand — Premium Storefront Pages

Build restrained, high-end landing pages for luxury goods (jewelry, watches, designer, AOV>$300).
...
- **luxury-expertise** — expert domain knowledge
- **google-traffic** — expert domain knowledge
...
### Commands
- `/generate-luxury-page` — Generate a luxury brand page — whitespace-driven, minimal sections, quiet CTAs
- `/create-luxury-assets` — Generate premium visual assets with editorial photography style and restrained compositing
...
Generate premium visual assets with editorial photography style and restrained compositing
