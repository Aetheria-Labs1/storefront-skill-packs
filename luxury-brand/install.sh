#!/bin/bash
# Lexsis AI Skill Pack Installer — Luxury Brand — Premium Storefront Pages
...
echo "║  Luxury Brand — Premium Storefront Pages       ║"
echo "╚══════════════════════════════════════════════════╝"
echo ""
...
if [ -d ".claude" ] || [ -f "CLAUDE.md" ]; then
  ...
  echo "  → Installed 14 skills + 2 commands"
  INSTALLED=true
fi
