---
name: brand-setup
description: Bootstrap a new workspace — verify connectivity, extract brand identity, configure the kit and theme, and verify everything renders correctly with `--lx-*` CSS variables.
