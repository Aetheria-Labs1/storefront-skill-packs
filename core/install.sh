#!/bin/bash
# Lexsis AI Skill Pack Installer — Lexsis AI — Core Skills
...
if [ -d ".claude" ] || [ -f "CLAUDE.md" ]; then
  ...
  echo "  → Installed 30 skills + 17 commands"
  INSTALLED=true
fi
