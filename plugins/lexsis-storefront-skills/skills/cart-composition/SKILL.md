...
description: How to compose a rich, customizable cart drawer using Cart V2 atomic islands. Load when generating PDP or landing pages for stores with `cart_v2` enabled.
