---
name: island-patterns-part2
description: How to properly embed, wrap, and combine React islands in vibe-code HTML sections. Load when using commerce or engagement islands. (Part 2 of 2)
---
