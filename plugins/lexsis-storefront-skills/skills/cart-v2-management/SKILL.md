...
description: How to generate, update, and manage Cart V2 configurations via MCP tools. Use these when the user asks to set up, modify, or configure their cart drawer behavior.
