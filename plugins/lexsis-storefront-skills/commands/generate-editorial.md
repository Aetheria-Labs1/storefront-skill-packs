---
description: Generate a magazine-style editorial page with shoppable products
...
- **premium-patterns**: Copy-and-adapt HTML+Tailwind patterns for common high-converting sections. Load when building hero, trust, CTA, or social proof sections.
