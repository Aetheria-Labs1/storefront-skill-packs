# Fashion — TikTok Ads Landing Pages

Build scroll-stopping fashion/streetwear landing pages for TikTok ad traffic.
...
- `generate-fashion-page` — Generate a fashion/streetwear landing page with editorial layouts and lookbook grids
- `optimize-tiktok-landing` — Optimize a page for TikTok ad traffic — mobile-first, fast scroll, video-native patterns
