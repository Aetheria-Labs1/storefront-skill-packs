# Lexsis AI — Storefront Starter Pack

Foundation skills for building Shopify landing pages with AI. Works with any vertical or traffic source.
...
### Commands
- `/generate-landing-page` — Generate a complete Shopify landing page from a brief or ad creative
- `/optimize-page` — Analyze and optimize an existing landing page for better conversions
...
Generate a complete Shopify landing page from a brief or ad creative
